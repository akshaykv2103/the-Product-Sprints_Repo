    ...
    },
{
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      {/* Hero section */}
      <header className="relative bg-[#0a0a0a] text-white pt-20 pb-32 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-r from-purple-900/10 via-pink-900/10 to-purple-900/10"></div>
          <div className="absolute top-0 left-0 w-full h-full bg-[url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80')] opacity-10 bg-cover bg-center"></div>
        </div>

        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400 animate-gradient leading-tight">
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden">
          <div className="w-full h-20 bg-gradient-to-t from-[#0a0a0a] to-transparent"></div>
        </div>
      </header>
      ...
      <section className="py-32 bg-[#0a0a0a] text-white relative">
        <div className="container mx-auto px-6">
          <h2 className="text-2xl font-semibold mb-24 text-center text-gray-400 tracking-wider uppercase">
            Outcomes You'll Get
          </h2>
                ...
                >
                  <div className="flex flex-col items-start relative">
                    ...
                    <div className="flex items-center gap-6 mb-6">
                      <div className="w-16 h-16 bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-2xl flex items-center justify-center backdrop-blur-xl">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              {reviews.map((review, index) => (
                <div
                  key={index}
                  className={`bg-[#0a0a0a] rounded-2xl p-8 border border-gray-800 transition-all duration-500 transform ${
                    index === activeReview
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-4 -right-4 text-6xl text-gray-800 font-serif rotate-180">"</div>
